...
fname_tau_y = 'relative_tau_init.tt3'  # File for the variable yield strength
#
# The file specified above must contain, as a function of location, initial indicators of tau
# from which the initial shear deformation is calculated.
# These values must lie between 0 and 1 such that the value tauy at a given location is
# given by  tauy = tauy_r + val*(tauy_i - tauy_r)
# the (global) initial yield stress tauy_i and
